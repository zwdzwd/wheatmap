...
WHeatmap(cc$mat, name='h1') +
  ...
  WLegendV('c3', RightOf('l1', pad=0.1), n.text=3, label.fontsize = 10)
...
```{r}
WHeatmap(matrix(1:9,nrow=3)) + WHeatmap(matrix(1:16,nrow=4), BottomRightOf(just='topleft')) + WHeatmap(matrix(1:9,nrow=3), BottomLeftOf(just='topright')) + WHeatmap(matrix(1:16,nrow=4), TopLeftOf(just='bottomright'))
```
