...
p$color.bar.bottom <- WColorBarH(rep(c(1,2,3),each=4), Beneath(WGroupColumn(p$heatmap, p$color.bar.middle, p$heatmap2)), cmp=CMPar(brewer.name='Set2'), continuous=FALSE)
WPlot(p)
```
