...
d <- both.cluster(a)
WHeatmap(d$mat,name='a') + WDendrogram(d$column.clust, RightOf('a'), facing = 'left') + WLegendV('a',BottomRightOf())
WHeatmap(d$mat,name='a') + WDendrogram(d$column.clust, RightOf('a'), facing = 'left') + WLegendV('a',BottomRightOf(h.pad=0.05), height=0.02)

WHeatmap(d$mat,name='a') + WDendrogram(d$column.clust, RightOf('a'), facing = 'left') + WLegendV('a',BottomRightOf(h.pad=0.05, just=c('left','top')), height=0.02)
