...
WHeatmap(cc$mat, name='h1') +
  ...
  WLabel('a little\nhouse', color='black', 
         Position(1,2,'h4',data.coord=TRUE, just=c('center','center'))) + 
  WRect(c(2,5),c(2,3),'h3.1.1',col='yellow') +
  WRect(c(5,6),c(2,3),'h1',col='yellow')
```
...
a <- a + WLabel('a little\nhouse', color='black', Position(1,2,'h4',data.coord=TRUE, just=c('center','center')))
a
```

And finally highlight some cells
```{r}
a <- a + WRect(c(2,5),c(2,3),'h3.1.1',col='yellow')
a <- a + WRect(c(5,6),c(2,3),'h1',col='yellow')
a
```
...
WHeatmap(matrix(1:9,nrow=3)) + WLabel('Wosai', Position(0.25,0.5,just=c('center','bottom')), fontsize=20, color='yellow')
```
...
## Highlights
```{r}
WHeatmap(matrix(1:20,nrow=4)) + WRect(c(2,3),c(3,3), color='red', lwd=10)
```
