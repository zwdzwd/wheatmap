...
We perform some cleaning to make sure nothing exists before
```{r}
ResetCanvas()
```
...
a + WDendrogram(cc$row.clust, LeftOf('c1'), facing='right')
...
a <- a + WHeatmap(matrix(rep(1:10),ncol=2),
                  LeftOf(WGroupRow('c4.1.1','h3.1.1')))
a
```
...
Let's add legend
```{r}
a <- a + WLegendV('c1', RightOf('h6.1.3'), 'l1')
